...
<div class="min-h-screen bg-gray-50 px-4 py-6 sm:px-6 lg:px-8 dark:bg-gray-900">
	<div class="mx-auto flex min-h-[calc(100vh-3rem)] max-w-5xl items-center justify-center">
		<div
			class="grid w-full gap-6 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-200 md:grid-cols-[1.1fr_0.9fr] md:p-8 dark:bg-gray-800 dark:ring-gray-700"
		>
			<div class="space-y-4">
				...
				<div
					class="rounded-xl bg-gray-100 p-4 text-sm text-gray-700 dark:bg-gray-900/50 dark:text-gray-200"
				>
			...
			<div class="space-y-4">
				{#if data.token && loading}
					<div
						class="rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-700 dark:border-blue-900 dark:bg-blue-950/40 dark:text-blue-200"
					>
				...
				<form onsubmit={handleSubmit} class="space-y-4">
					...
					{#if error}
						<p
							class="rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300"
						>
							{error}
						</p>
					{/if}
